...
/*!***********************!*\
  !*** ./js/booking.js ***!
  \***********************/
/*! exports provided: submitFormBooking, getMask */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var nameBooking = document.getElementById('name');
var phoneBooking = document.getElementById('tel');
...
var getMask = function getMask() {
  if (phoneBooking) {
    Object(imask__WEBPACK_IMPORTED_MODULE_0__["default"])(phoneBooking, maskOptions);
  }
};
var submitForm = function submitForm(name, tel, email) {
...
/* harmony import */ var _menu_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./menu.js */ "./js/menu.js");
/* harmony import */ var _booking_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./booking.js */ "./js/booking.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_menu_js__WEBPACK_IMPORTED_MODULE_2__["activateMenu"])();
  Object(_booking_js__WEBPACK_IMPORTED_MODULE_3__["submitFormBooking"])();
  Object(_booking_js__WEBPACK_IMPORTED_MODULE_3__["getMask"])();
  ymaps.ready(_map_js__WEBPACK_IMPORTED_MODULE_4__["yandexMap"]);
  Object(_scroll_js__WEBPACK_IMPORTED_MODULE_5__["scrollTo"])();
...
/* eslint-disable no-undef */
var COORDINATES = [59.937511252406686, 30.322611701832432];
var ZOOM = 16;
var yandexMap = function yandexMap() {
  if (document.getElementById('map')) {
    ...
    var pin = new ymaps.Placemark(COORDINATES, {}, {
...
/*!********************!*\
  !*** ./js/menu.js ***!
  \********************/
/*! exports provided: activateMenu */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "activateMenu", function() { return activateMenu; });
...
var travelLink = document.getElementById('travel-link');
var contactsLink = document.getElementById('contacts-link');
var benefitsLinkFooter = document.getElementById('benefits-link-footer');
var catalogLinkFooter = document.getElementById('catalog-link-footer');
var travelLinkFooter = document.getElementById('travel-link-footer');
var contactsLinkFooter = document.getElementById('contacts-link-footer');
var closeMenu = function closeMenu() {
...
var scrollToBenefits = function scrollToBenefits() {
  if (benefits && benefitsLink) {
    benefitsLink.addEventListener('click', function (evt) {
      evt.preventDefault();
      scroll(benefits);
      closeMenu();
    });
  ...
  if (benefits && benefitsLinkFooter) {
    benefitsLinkFooter.addEventListener('click', function (evt) {
      evt.preventDefault();
      scroll(benefits);
      closeMenu();
    });
...
var scrollToCatalog = function scrollToCatalog() {
  ...
  if (catalog && catalogLinkFooter) {
    catalogLinkFooter.addEventListener('click', function (evt) {
      evt.preventDefault();
      scroll(catalog);
      closeMenu();
    });
...
var scrollToTravel = function scrollToTravel() {
  if (travel && travelLink) {
    travelLink.addEventListener('click', function (evt) {
      evt.preventDefault();
      scroll(travel);
      closeMenu();
    });
  ...
  if (travel && travelLinkFooter) {
    travelLinkFooter.addEventListener('click', function (evt) {
      evt.preventDefault();
      scroll(travel);
      closeMenu();
    });
...
var scrollToContacts = function scrollToContacts() {
  ...
  if (contacts && contactsLinkFooter) {
    contactsLinkFooter.addEventListener('click', function (evt) {
      evt.preventDefault();
      scroll(contacts);
      closeMenu();
    });
